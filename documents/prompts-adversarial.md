...
- [Adversarial Prompting](#adversarial-prompting)
  ...
  - [Defense Tactics](#defense-tactics)
    - [Add Defense in the Instruction](#add-defense-in-the-instruction)
    - [Parameterizing Prompt Components](#parameterizing-prompt-components)
    - [Quotes and Additional Formatting](#quotes-and-additional-formatting)
    - [Adversarial Prompt Detector](#adversarial-prompt-detector)
