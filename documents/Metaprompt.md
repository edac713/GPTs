...
metaprompt = '''
Human: Today you will be writing instructions to an eager, helpful, but inexperienced and unworldly AI assistant who needs careful instruction and examples to understand how best to behave. I will explain a task to you. You will write instructions that will direct the assistant on how best to accomplish the task consistently, accurately, and correctly. Here are some examples of tasks and instructions.
...
if variable_string:
    prompt += variable_string + "\n</Inputs><Instructions_Structure>"
...
Now, we'll extract the prompt itself and the variables needed
...
def extract_prompt(metaprompt_response):
    return extract_between_tags("Instructions", metaprompt_response)[0]
